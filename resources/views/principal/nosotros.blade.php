        ...
        <section class="index">
            ...
            <section class="prods">
                <div class="card">
                    ...
                    <h3>Test Drive</h3>
                    <p>Puedes realizar una preueba de manejo garantizada sin ningun compromiso para mayor conformidad antes de adquirir tu primer vehiculo.</p>
                ...
                <div class="card">
                    ...
                    <h3>Cotizar</h3>
                    <p>En esta ventana podras realizar una cotizacion de tu vehiculo personalizado a tu gusto y con preferencias unicas y calcular toda la cotizacion total del vehiculo</p>
                ...
                <div class="card">
                    ...
                    <h3>Accesorios</h3>
                    <p>En esta ventana podras buscar todo tipo de accesorios de vehiculo tanto repuesto o piezas orginales para tu vehiculo y podras cotizar el precio total del repuesto.</p>
                ...
                <div class="card">
                    ...
                    <h3>Configurar</h3>
                    <p>Aqui en esta ventana podras configurar todo acerca de tu primer vehiculo tanto las piezas como los complementos de tu primer vehiculo a la par podras cotizarlo el precio total del vehiculo una vez configurado tu primer vehiculo</p>
